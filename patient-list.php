...
<head>
        ...
        <title>BHCS - Patient List Page</title>
					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-12">
								...
								<!-- <a style="float:right;" class="btn btn-success" href="patient-add.php">Add Patient</a> -->
												 ...
												 <tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="profile.php?edit=<?php echo htmlentities($result->uid);?>" class="avatar avatar-sm mr-2"><?php if($result->profile_picture == null) { ?>
																				<img class="avatar-img rounded-circle" src="assets/img/profile/No-image-available.png" alt="User Image">
																				<?php } else { ?>
																					<img class="avatar-img rounded-circle" src="assets/img/profile/<?php echo htmlentities($result->profile_picture); ?>" alt="User Image">
																					<?php } ?></a>
													...
													<!-- <td><a class="btn btn-sm bg-success-light" href = "profile.php?edit=<?php echo htmlentities($result->uid);?>"> <i class="fe fe-pencil"></i> Edit</a>

                    <a class="btn btn-sm bg-danger-light" href = "patient-list.php?del=<?php echo htmlentities($result->uid);?>" onclick = "return confirm('Do you really want to Delete this Doctor')"> <i class="fe fe-trash"></i> Delete</a>
                    </td> -->
												</tr> 
												<?php $cnt = $cnt + 1;
												}
